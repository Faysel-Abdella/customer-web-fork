...
const Features = () => {
  return (
    <div className="flex w-full flex-col items-center justify-center gap-48 px-32 py-28">
      <div className="flex w-full justify-evenly gap-8">
        {features.map((feature, index) => (
          <div
            key={index}
            className={cn(
              "dark:bg-secondary dark:border-border relative flex h-fit flex-col items-center justify-center gap-5 rounded-tr-4xl rounded-bl-4xl border bg-yellow-500/20 p-8",
          ...
          >
            <Image
              ...
              height={100}
            />
            <div className="dark:text-foreground flex flex-col items-center justify-center gap-2 px-10 text-center text-gray-800">
            ...
            <div className="absolute -top-4 flex w-full justify-center">
              <div className="border-background before:conten-[' '] before:bg-muted-foreground dark:before:bg-secondary size-8 rounded-full border-8 bg-gray-800 before:absolute before:-z-10 before:h-40 before:w-1 before:translate-x-1.5 before:-translate-y-full" />
            </div>
          </div>
        ))}
      </div>
      <div className="flex h-96 w-full rounded-tr-4xl rounded-bl-4xl bg-gradient-to-r from-orange-500 to-orange-600">
        <div className="flex h-full w-1/2 flex-col justify-center gap-10 pl-10">
